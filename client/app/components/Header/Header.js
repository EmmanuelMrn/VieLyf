...
class Header extends Component {
  ...
  updatethings() {
    ...
    fetch(
      "/api/account/getnotifications?token=" + localStorage.getItem("clientID"),
      { method: "GET" }
    )
      .then(res => res.json())
      .then(json2 => {
          ...
          <div className="sidebar">
            ...
            <div className="news_inner">
              {this.state.items.map(function(client) {
                ...
                var day = moment()
                  .subtract(new Date(client.requestDate).getDay())
                  .startOf("day")
                  .format("dddd");
                var daydate = moment()
                  .subtract(new Date(client.requestDate).getDay())
                  ...
                  .format("dddd");
                var monthMinusOneName = moment()
                  .subtract(new Date(client.startDateTime).getMonth())
                  .startOf("month")
                  .format("MMMM");
                var diferencia =
                  new Date(client.startDateTime).getHours() -
