...
export default class Agenda extends Component {
  ...
  componentDidMount() {
    fetch("/api/account/agendaarray?token=" + localStorage.getItem("Auth"), {
      method: "GET"
    })
      .then(res => res.json())
      .then(json1 => {
  ...
  render() {
    ...
    return (
      <div className="content-expanded ">
        <div className="">
          <button className="btn btn-secondary" onClick={this.zoomIn}>
            {" "}
            <i className="zoom-plus-icon" /> zoomIn
          </button>
          <button className="btn btn-secondary" onClick={this.zoomOut}>
            {" "}
            <i className="zoom-minus-icon" /> zoomOut
          </button>
          <button className="btn btn-secondary" onClick={this._openModal}>
            {" "}
            <i className="schedule-icon" /> Nuevo{" "}
          </button>
          <button
