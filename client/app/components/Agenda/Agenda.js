...
export default class Agenda extends Component {
  ...
  componentDidMount(){
    ...
    // var items = $.map(itemsArray, function(value, index) { return [value]; });
    // itemsArray.sort().reverse();
    // // var dat = new Date();
    ...
    // var items = [
      ...
      //   "startDateTime" : new Date("2018-07-10 13:00:00.000"),
      //   "endDateTime"   : new Date("2018-07-10 14:00:00.000"),
      //   "classes"       : 'color-2'
      // },
      // {
      //   "_id"            :guid(),
      //   "name"          : 'Working lunch , Holly',
      //   "startDateTime" : new Date(now.getFullYear(), now.getMonth(), now.getDate()+1, 13, 0),
      //   "endDateTime"   : new Date(now.getFullYear(), now.getMonth(), now.getDate()+1, 14, 0),
      //   "classes"       : 'color-2'
      // },
